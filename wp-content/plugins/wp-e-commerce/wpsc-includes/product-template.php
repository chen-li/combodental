...
//			$output .= "<a href=\"". remove_query_arg('paged' ) . "\" title=\"" . __('First Page', 'wpsc') . "\">" . __('&laquo; First', 'wpsc') . "</a>";
		...
		if($current_page > 1) {
			$previous_page = $current_page - 1;
			if( $previous_page == 1 )
				$output .= "<span class=\"prev\"><a href=\"". remove_query_arg( 'paged' ) . $additional_links . "\" title=\"" . __('Previous Page', 'wpsc') . "\"><i class=\"icon-placeholder\"></i>" . __('Previous', 'wpsc') . "</a></span>";
			else
				$output .= "<span class=\"prev\"><a href=\"". add_query_arg( 'paged', ($current_page - 1) ) . $additional_links . "\" title=\"" . __('Previous Page', 'wpsc') . "\"><i class=\"icon-placeholder\"></i>" . __('Previous', 'wpsc') . "</a></span>";
		} else {
			$output .= "<span class=\"prev disabled\"><i class=\"icon-placeholder\"></i>" . __('Previous', 'wpsc') . "</span>";
        }
		...
		if($current_page < $totalpages) {
			$next_page = $current_page + 1;
			$output .= "<span class=\"next\"><a href=\"". add_query_arg( 'paged', $next_page ) . "\" title=\"" . __('Next Page', 'wpsc') . "\">" . __('Next', 'wpsc') . "<i class=\"icon-placeholder\"></i></a></span>";
		} else {
			$output .= "<span class=\"next disabled\">" . __('Next', 'wpsc') . "<i class=\"icon-placeholder\"></i></span>";
        }
