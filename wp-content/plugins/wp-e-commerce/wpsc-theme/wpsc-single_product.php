...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">
                        <div class="imagecol">
                            <?php if ( wpsc_the_product_thumbnail() ) :
                                if (has_post_thumbnail()): ?>
                                    ...
                                    <img src="<?php echo wpsc_the_product_image(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>"/>
                                 <?php endif;
						 ...
						 */
						?>
                        <?php if (false && wpsc_have_custom_meta()) : ?>
						...
						<form class="product_form" enctype="multipart/form-data" action="<?php echo esc_url( wpsc_this_page_url() ); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
							...
							<?php if ( false && wpsc_product_has_personal_text() ) : ?>
							...
							<?php if ( false && wpsc_product_has_supplied_file() ) : ?>
